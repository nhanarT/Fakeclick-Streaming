...
def get_sql_query(
    ...
    config_map = {
        ...
        'sink_attributed_checkouts': ApplicationUsersTableConfig(),
        'process_attributed_checkouts': ApplicationAttributedCheckoutsTableConfig(),
    }
...
def run_checkout_attribution_job(
    ...
    # Create Sink DDL
    t_env.execute_sql(get_sql_query('sink_attributed_checkouts', 'sink'))

    # Run processing query
    stmt_set = t_env.create_statement_set()
    stmt_set.add_insert_sql(get_sql_query('process_attributed_checkouts', 'process'))
